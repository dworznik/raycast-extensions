...
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [Display Rotation](extensions/display-rotation)         | Rotates a display between its natural and 90° layout with `displayplacer` — toggles, or takes an explicit rotation |
